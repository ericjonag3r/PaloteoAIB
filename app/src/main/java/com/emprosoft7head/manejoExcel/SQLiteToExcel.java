package com.emprosoft7head.manejoExcel;
...
public class SQLiteToExcel {
    ...
    public SQLiteToExcel(Context context, String dbName, Formulario formulario) {
        this(context, dbName, Environment.getExternalStorageDirectory().toString() + File.separator,formulario);
        this.formulario =formulario;
    }

    public SQLiteToExcel(Context context, String dbName, String exportPath,Formulario formulario) {
    ...
    private void exportTables(List<String> tables, final String fileName) throws Exception {
        ...
        File f = new File(formulario.getExternalCacheDir(),fileName);
        ...
        FileOutputStream fos = new FileOutputStream(fileArchivo);
        workbook.write(fos);
        fos.flush();
        fos.close();
        workbook.close();
        database.close();
            ...
            Log.e("SQLiteToExcel/exportTab",e.toString());
        }
    }
